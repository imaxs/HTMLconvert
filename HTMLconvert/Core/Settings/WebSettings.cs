namespace HTMLconvert.Core.Settings
{
    ...
    {
        /// <summary>Should we print the background. Default = true</summary>
        [WkHtml("web.background")]
        public bool? Background { get; set; }

        /// <summary>Should we load images. Default = true</summary>
        [WkHtml("web.loadImages")]
        public bool? LoadImages { get; set; }

        /// <summary>Should we enable javascript. Default = true</summary>
        ...
        /// <summary>The minimum font size allowed. Default = -1</summary>
