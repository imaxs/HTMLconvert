namespace HTMLconvert.Core
{
    ...
    public class PaperSize
    {
        ...
        private static readonly Dictionary<PaperKind, PaperSize> m_Dictionary = new Dictionary<PaperKind, PaperSize>()
        {
        ...
        public static implicit operator PaperSize(PaperKind paperKind) => m_Dictionary[paperKind];
    }
}